...
## Важно про публичный kit и приватную память

Этот репозиторий — публичный setup kit. Твоя настоящая память должна жить в отдельном приватном memory-репозитории.

Не коммить сюда реальные memory files, `.env`, tokens, private keys или локальные пути с личными данными.
