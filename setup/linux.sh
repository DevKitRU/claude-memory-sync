...
# ——— Шаг 6: smart cron wrapper-скрипт + запись (идемпотентно)
info "Шаг 6/7: smart auto-pull через cron"
...
echo "  • Cron запускает smart auto-pull раз в 15 мин через $WRAPPER"
