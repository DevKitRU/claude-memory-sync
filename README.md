...
3. Настраиваешь smart auto-pull через cron, launchd или Task Scheduler.

По умолчанию setup ставит smart auto-pull раз в 15 минут. Он не трогает репо с локальными изменениями и не делает merge сам. На Windows он ещё пропускает запуск во время игры, VR или высокой нагрузки CPU.
